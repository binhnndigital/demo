...
class SheerIDVerifier:
    ...
    def verify(self, first_name: str = None, last_name: str = None,
        ...
        """
        Execute complete verification process, remove status polling to reduce time
        """
        try:
            ...
            # Generate teacher certificate PDF + PNG
            logger.info("Step 1/4: Generating teacher certificate PDF and PNG...")
            ...
            # 步骤 4: 上传文档并完成提交
            logger.info("Step 4/4: Request and upload documents...")
            step4_body = {
                'files': [
                    {
            ...
            logger.info("✓ Teacher certificate PDF/PNG uploaded successfully")
            ...
            # No status polling, directly return waiting for review
            return {
                'success': True,
                'pending': True,
